...
const cucumberJsonDir = path.resolve(process.cwd(), "cypress/integration/reports/cucumber-json");
const cucumberReportFileMap = {};
const cucumberReportMap = {};
const jsonIndentLevel = 2;
const htmlReportDir = path.resolve(process.cwd(), "cypress/integration/reports/html");
const screenshotsDir = path.resolve(process.cwd(), "cypress/integration/reports/cypress-screenshots/**/**/");
...
function generateReport() {
  if (!fs.existsSync(cucumberJsonDir)) {
    ...
    report.generate({
      ...
      useCDN: true,
      pageTitle: "Cyress-Cucumber Execution Report",
      reportName: `Cyress-Cucumber Execution Report - ${new Date().toLocaleString()}`,
      metadata: {
        app: {
      ...
      customData: {
        title: "Run info",
        data: [
          { label: "Project", value: "Cypress cucumber template" },
